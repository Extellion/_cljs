...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26726 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26726(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26727 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26727(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26728 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26728(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26748 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26748(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26749 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26749(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26750 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26750(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26759 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26759(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26762 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26762(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26768 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26768(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26771 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26771(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26785 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26785(b);
}
});
