...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31135 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31135(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31146 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31146(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31149 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31149(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31155 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31155(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31160 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31160(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31163 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31163(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31109,callback){
var map__31110 = p__31109;
var map__31110__$1 = cljs.core.__destructure_map(map__31110);
var input = map__31110__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31110__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31110__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
