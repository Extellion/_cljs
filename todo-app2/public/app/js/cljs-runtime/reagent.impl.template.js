...
var G__27612 = o;
reagent.impl.template.goog$module$goog$object.set(G__27612,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__27613 = o;
reagent.impl.template.goog$module$goog$object.set(G__27613,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__27635__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__27636__i < G__27636__a.length) {G__27636__a[G__27636__i] = arguments[G__27636__i + 0]; ++G__27636__i;}
  args = new cljs.core.IndexedSeq(G__27636__a,0,null);
} 
return G__27635__delegate.call(this,args);};
G__27635.cljs$lang$maxFixedArity = 0;
G__27635.cljs$lang$applyTo = (function (arglist__27637){
var args = cljs.core.seq(arglist__27637);
return G__27635__delegate(args);
});
...
var G__27614 = props;
var G__27614__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27614,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27614);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27614__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27615 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27615,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27615;
}
})(),id_class);
...
var G__27616 = (cljs.core.count(argv) - first_child);
switch (G__27616) {
case (0):
...
var vec__27617 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(2),null);
...
var temp__5757__auto___27650 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___27650 == null)){
} else {
var key_27651 = temp__5757__auto___27650;
(jsprops.key = key_27651);
}
...
var temp__5757__auto___27653 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___27653 == null)){
} else {
var key_27654 = temp__5757__auto___27653;
(jsprops.key = key_27654);
}
...
var temp__5757__auto___27655 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___27655 == null)){
} else {
var key_27656 = temp__5757__auto___27655;
(jsprops.key = key_27656);
}
...
var temp__5757__auto___27665 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27665 == null)){
} else {
var key_27666 = temp__5757__auto___27665;
(jsprops.key = key_27666);
}
...
var temp__5757__auto___27669 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27669 == null)){
} else {
var key_27670 = temp__5757__auto___27669;
(jsprops.key = key_27670);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27620_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27620_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27621 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27621,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27621,(1),null);
...
break;
default:
var G__27677 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27678 = compiler;
v = G__27677;
compiler = G__27678;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27627 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27627 = (function (opts,id,fn_to_element,parse_fn,meta27628){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27627.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27629,meta27628__$1){
var self__ = this;
var _27629__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27627(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta27628__$1));
}));

(reagent.impl.template.t_reagent$impl$template27627.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27629){
var self__ = this;
var _27629__$1 = this;
return self__.meta27628;
}));

(reagent.impl.template.t_reagent$impl$template27627.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27627.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27627.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template27627.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27627.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27627.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta27628","meta27628",-502702121,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27627.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27627.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27627");

(reagent.impl.template.t_reagent$impl$template27627.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template27627");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27627.
 */
reagent.impl.template.__GT_t_reagent$impl$template27627 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27627(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27628){
return (new reagent.impl.template.t_reagent$impl$template27627(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27628));
});

}

return (new reagent.impl.template.t_reagent$impl$template27627(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
