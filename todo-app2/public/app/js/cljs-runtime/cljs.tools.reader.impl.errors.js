...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26521,G__26522,seq26520__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___26734 = arguments.length;
var i__4865__auto___26735 = (0);
while(true){
if((i__4865__auto___26735 < len__4864__auto___26734)){
args__4870__auto__.push((arguments[i__4865__auto___26735]));

var G__26736 = (i__4865__auto___26735 + (1));
i__4865__auto___26735 = G__26736;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq26536){
var G__26537 = cljs.core.first(seq26536);
var seq26536__$1 = cljs.core.next(seq26536);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26537,seq26536__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq26545){
var G__26546 = cljs.core.first(seq26545);
var seq26545__$1 = cljs.core.next(seq26545);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26546,seq26545__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___26753 = arguments.length;
var i__4865__auto___26754 = (0);
while(true){
if((i__4865__auto___26754 < len__4864__auto___26753)){
args__4870__auto__.push((arguments[i__4865__auto___26754]));

var G__26755 = (i__4865__auto___26754 + (1));
i__4865__auto___26754 = G__26755;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq26563){
var G__26564 = cljs.core.first(seq26563);
var seq26563__$1 = cljs.core.next(seq26563);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26564,seq26563__$1);
}));
...
var init = (function (){var G__26624 = kind;
var G__26624__$1 = (((G__26624 instanceof cljs.core.Keyword))?G__26624.fqn:null);
switch (G__26624__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26624__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq26619){
...
var iter__4652__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26691(s__26692){
return (new cljs.core.LazySeq(null,(function (){
var s__26692__$1 = s__26692;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__26692__$1);
if(temp__5753__auto__){
var s__26692__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26692__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__26692__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__26694 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__26693 = (0);
while(true){
if((i__26693 < size__4651__auto__)){
var vec__26697 = cljs.core._nth(c__4650__auto__,i__26693);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26697,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26697,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__26694,id);

var G__26804 = (i__26693 + (1));
i__26693 = G__26804;
continue;
} else {
var G__26805 = (i__26693 + (1));
i__26693 = G__26805;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26694),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26691(cljs.core.chunk_rest(s__26692__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26694),null);
}
} else {
var vec__26701 = cljs.core.first(s__26692__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26691(cljs.core.rest(s__26692__$2)));
} else {
var G__26806 = cljs.core.rest(s__26692__$2);
s__26692__$1 = G__26806;
continue;
}
}
} else {
