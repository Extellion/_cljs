...
if((typeof cljs !== 'undefined') && (typeof cljs.core !== 'undefined') && (typeof cljs.core.async !== 'undefined') && (typeof cljs.core.async.impl !== 'undefined') && (typeof cljs.core.async.impl.ioc_helpers !== 'undefined') && (typeof cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29242 !== 'undefined')){
} else {
...
(cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29242.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers29242");
}));

/**
 * Positional factory function for cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers29242.
 */
cljs.core.async.impl.ioc_helpers.__GT_t_cljs$core$async$impl$ioc_helpers29242 = (function cljs$core$async$impl$ioc_helpers$fn_handler_$___GT_t_cljs$core$async$impl$ioc_helpers29242(f__$1,meta29243){
return (new cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29242(f__$1,meta29243));
});
...
var fexpr__29279 = cljs.core.async.impl.ioc_helpers.aget_object(state,(0));
return (fexpr__29279.cljs$core$IFn$_invoke$arity$1 ? fexpr__29279.cljs$core$IFn$_invoke$arity$1(state) : fexpr__29279.call(null,state));
});
...
var statearr_29291_29325 = state;
(statearr_29291_29325[(2)] = x);

(statearr_29291_29325[(1)] = blk);
...
var statearr_29293_29326 = state;
(statearr_29293_29326[(2)] = cljs.core.deref(cb));

(statearr_29293_29326[(1)] = blk);
...
var statearr_29296_29327 = state;
(statearr_29296_29327[(2)] = ret_val);

(statearr_29296_29327[(1)] = blk);
...
if(cljs.core.truth_(temp__5751__auto__)){
var cb = temp__5751__auto__;
var statearr_29299_29329 = state;
(statearr_29299_29329[(2)] = cljs.core.deref(cb));

(statearr_29299_29329[(1)] = blk);
